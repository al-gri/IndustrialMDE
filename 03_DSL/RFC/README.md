...
| [RFC-0002](RFC-0002-Type-System.md) | Type System | Draft | RFC-0000, RFC-0001, RFC-0001A, RFC-0001B, RFC-0001C | Not Started |
...
- review of Draft RFC-0002 intrinsic domains, type identity, diagnostic precedence, and unresolved `REAL` exceptional-value semantics;
