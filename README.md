...
- [RFC-0001B](03_DSL/RFC/RFC-0001B-Identifiers-Scopes-and-Namespaces.md) is a Draft review artifact; RFC-0001C is not yet drafted.
...
3. review the Proposed core semantic model and the Draft identifier, scope, namespace, and import rules;
